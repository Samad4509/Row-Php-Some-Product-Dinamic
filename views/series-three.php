            ...
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <div class="card card-body">
                        <h1 class="text-center"> This Series Three</h1>
                        <hr/>
                        <form action="action.php" method="post">
                            ...
                            <div class="row mb-4">
                              ...
                              <textarea class="form-control">
                                  <?php echo isset($_GET['result'])?  base64_decode($_GET['result']):'';?>
                              </textarea>
                                </div>
                            </div>
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input type="submit" class="btn btn-success" name="series-three-button" value="Submit"/>
                                </div>
                            </div>
                        </form>
                    </div>
